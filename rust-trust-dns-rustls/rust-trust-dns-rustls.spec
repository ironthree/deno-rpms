...
URL:            https://crates.io/crates/trust-dns-rustls
...
DNS client to use rustls for TLS.}
...
%if %{with check}
%check
# skip test that requires a file that is not shipped with published crates
