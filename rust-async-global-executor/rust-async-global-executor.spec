...
Patch0:         async-global-executor-fix-metadata.diff
...
This package contains library source intended for building other packages
which use "tokio-crate" feature of "%{crate}" crate.
...
This package contains library source intended for building other packages
which use "tokio02-crate" feature of "%{crate}" crate.
...
%changelog
* Thu Apr 29 2021 Fabio Valentini <decathorpe@gmail.com> - 2.0.2-1
- Initial package
