...
Version:        2.2.0
Release:        1%{?dist}
Summary:        Provides an enum with every valid Direct Rendering Manager (DRM) format fourcc
...
This package contains library source intended for building other packages
which use "build_bindings" feature of "%{crate}" crate.
...
%changelog
* Tue Sep 07 2021 Fabio Valentini <decathorpe@gmail.com> - 2.2.0-1
- Initial package
