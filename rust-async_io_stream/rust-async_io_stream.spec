...
%files          devel
%license LICENSE
%doc CHANGELOG.md CONTRIBUTING.md README.md TODO.md
...
This package contains library source intended for building other packages which
use the "map_pharos" feature of the "%{crate}" crate.
...
This package contains library source intended for building other packages which
use the "pharos" feature of the "%{crate}" crate.
...
This package contains library source intended for building other packages which
use the "tokio_io" feature of the "%{crate}" crate.
...
%changelog
* Tue Sep 07 2021 Fabio Valentini <decathorpe@gmail.com> - 0.3.2-1
