...
URL:            https://crates.io/crates/trust-dns-https
...
DNS client to use DNS over HTTPS.}
...
%cargo_test -- --  --skip test_https_cloudflare --skip test_https_google
%endif
