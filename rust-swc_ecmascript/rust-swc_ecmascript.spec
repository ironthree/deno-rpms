...
%package     -n %{name}+minifier-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+minifier-devel %{_description}

This package contains library source intended for building other packages
which use "minifier" feature of "%{crate}" crate.

%files       -n %{name}+minifier-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%package     -n %{name}+preset_env-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+preset_env-devel %{_description}

This package contains library source intended for building other packages
which use "preset_env" feature of "%{crate}" crate.

%files       -n %{name}+preset_env-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%package     -n %{name}+swc_ecma_minifier-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+swc_ecma_minifier-devel %{_description}

This package contains library source intended for building other packages
which use "swc_ecma_minifier" feature of "%{crate}" crate.

%files       -n %{name}+swc_ecma_minifier-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%package     -n %{name}+swc_ecma_preset_env-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+swc_ecma_preset_env-devel %{_description}

This package contains library source intended for building other packages
which use "swc_ecma_preset_env" feature of "%{crate}" crate.

%files       -n %{name}+swc_ecma_preset_env-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%package     -n %{name}+typescript-parser-devel
Summary:        %{summary}
BuildArch:      noarch

%description -n %{name}+typescript-parser-devel %{_description}

This package contains library source intended for building other packages
which use "typescript-parser" feature of "%{crate}" crate.

%files       -n %{name}+typescript-parser-devel
%ghost %{cargo_registry}/%{crate}-%{version_no_tilde}/Cargo.toml
...
%changelog
* Tue Sep 07 2021 Fabio Valentini <decathorpe@gmail.com> - 0.52.1-1
- Update to version 0.52.1.

* Mon Jun 07 2021 Fabio Valentini <decathorpe@gmail.com> - 0.33.0-1
